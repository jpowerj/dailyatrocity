    ...
    return (
        <>
            <Modal
                ...
                title={<Text style={{ fontWeight: 'bold' }}>DailyAtrocity.US</Text>}
            >
                <p style={{ paddingBottom: '8px' }}>
                    GitHub source <a href="https://github.com/jpowerj/dailyatrocity" className={classes.modalLink} target="_blank" rel="noopener noreferrer">here</a>.
                </p>
                <p>
